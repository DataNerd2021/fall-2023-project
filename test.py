...
def load_data(*args, **kwargs):
    ...
    while page_num <= max_page_num:
        ...
        url= f'https://www.truecar.com/used-cars-for-sale/listings/{make}/{model}/?page={page_num}&searchRadius=500&sort[]=year_asc'
        ...
        for result in results:
                ...
                try:
                    header.append(result.find('div', {'data-test': 'vehicleCardYearMakeModel'}).get_text())
                except:
                    break
